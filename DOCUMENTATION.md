...
| `--dx` | Voxel size in X (mm) | `0.25` |
| `--dy` | Voxel size in Y (mm) | `0.25` |
| `--dz` | Voxel size in Z (mm) | `0.25` |
...
| Parameter | Description | Default |
|-----------|-------------|---------|
| `--alpha_endo_lv` | Helix angle at LV endocardium | `60°` |
| `--alpha_epi_lv` | Helix angle at LV epicardium | `-60°` |
...
| `--alpha_endo_rv` | Helix angle at RV endocardium | `60°` |
| `--alpha_epi_rv` | Helix angle at RV epicardium | `-60°` |
