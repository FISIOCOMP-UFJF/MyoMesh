...
- `--alpha_endo_lv`: Fiber angle on the left ventricle (LV) endocardium. Default value is 60°.
- `--alpha_epi_lv`: Fiber angle on the left ventricle (LV) epicardium. Default value is -60°.
...
- `--alpha_endo_rv`: Fiber angle on the right ventricle (RV) endocardium. Default value is 60°.
- `--alpha_epi_rv`: Fiber angle on the right ventricle (RV) epicardium. Default value is -60°.
